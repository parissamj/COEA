...
well_data_headings, well_data, field_name = get_all_post_2005_well_data()
...
ask_production = 'Y' ########str(raw_input('Get Production Data (Y/N) ?:   '))
print('\n')
...
ask_injection = 'Y' ########str(raw_input('Get Injection Data (Y/N) ?:   '))
print('\n')
...
ask_fluid_data = 'Y' ##########str(raw_input('Get Fluid Data (Y/N) ?:   '))
print('\n')
...
ask_DST_data = 'N' #########str(raw_input('Get Pressure/DST data (Y/N)?:  '))
print('\n')
...
ask_water_data = 'Y' ###########str(raw_input('Get HF Water Data (Y/N) ?:   '))
print('\n')
...
print('\n')
ask_facility_data = 'Y' #######str(raw_input('Get Facility Data (Y/N) ?:   '))
print('\n')
...
if ask_facility_data.upper() == 'Y':
	...
	start_date = '2018-01' ########str(raw_input('Start Date (YYYY-MM):   '))
	end_date = '2018-06' ########str(raw_input('End Date (YYYY-MM):   '))
	print('\n')

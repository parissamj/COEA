...
def get_fluid_data(fluid_type,well_data,):
	...
	if fluid_type.upper() == 'GAS':
		file_location = map_to_drive() + "/Project Data_new/geoSCOUT_data/post 2005 gas_analysis.csv"
	#if fluid_type.upper() == 'WATER':
	#	file = formation + '_' + fluid_type + '_analysis.csv' 
	if fluid_type.upper() == 'OIL':
		file_location = map_to_drive() + "/Project Data_new/geoSCOUT_data/post 2005 oil_analysis.csv"

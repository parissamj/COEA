...
def well_search():
	...
	#The main one
	file_location = map_to_drive() + "Project Data_new/geoSCOUT_data/post 2005 well_data.csv"
	...
	###Alex's Original code (lines 87 to 91. If uncomment these lines then must Must uncomment lines 107 to 115)
	# #formations
	formations = 'SEARCH'
	...
	###Parissa's code for reading Formations
	# formations = ""
	# formations_file = open("runfiles/list_of_producing_formations.txt", "r")
	# lines = formations_file.readlines()
	# for line in lines:
	# 	line = line.strip()
	# 	if line.startswith("#"):
	# 		continue
	# 	if len(line)==0:
	# 		continue
	# 	formations = formations + line + ","
	

	##Alex's original code for finding formations

...
def injection_dates():
	...
	start_date = '2018-01' ######str(raw_input('Enter the Start Date (YYYY-MM): '))
	end_date = '2018-06' ######str(raw_input('Enter the End Date (YYYY-MM): '))
	print('\n')

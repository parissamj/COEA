...
def single_facility_OPGEE(facility_summary, OPGEE_data, facility_to_well, geoscout_fac_data, geoscout_fac_data_headings,facility_connection_dates):
	...
	for facility in facility_summary:
		#print("the facility is:", facility, facility_summary[facility])
		#if 'BT' in facility:
			...
			if facility != 'ALL':
				...
				for well in facility_to_well[facility]:
					...
					if well in OPGEE_data:
						#print("ssssssssssssssssssssss:", dates_key,facility_connection_dates[dates_key])
	...
	print("\n")	
	print("%%%%%%%%%%%%%%%Accumulated Wells:\n")
	#print(well_cumulative)
...
def AB_facility_analysis(well_data, well_data_headings, OPGEE_data, dates_array):
	...
	if len(well_data) != 0:
		ask_include_GP = 'Y' #########str(raw_input('Would you like to include Gas Processing Plants? (Y/N) :    '))
		print('\n')
	else:
		ask_include_GP = 'N'
...
if __name__ == '__main__':
	...
	dates_array = dates_array = dates_array('2018-01','2018-6')
	#dates_array = ['2017-06']
